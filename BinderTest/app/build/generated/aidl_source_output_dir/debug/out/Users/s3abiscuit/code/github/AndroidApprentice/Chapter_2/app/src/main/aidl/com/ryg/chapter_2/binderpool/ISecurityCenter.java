...
{
  /** Default implementation for ISecurityCenter. */
  public static class Default implements com.ryg.chapter_2.binderpool.ISecurityCenter
  {
  ...
  public static abstract class Stub extends android.os.Binder implements com.ryg.chapter_2.binderpool.ISecurityCenter
  {
    ...
    private static class Proxy implements com.ryg.chapter_2.binderpool.ISecurityCenter
    {
      ...
      @Override public java.lang.String encrypt(java.lang.String content) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_encrypt, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().encrypt(content);
          }
      ...
      @Override public java.lang.String decrypt(java.lang.String password) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_decrypt, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().decrypt(password);
          }
          _reply.readException();
          _result = _reply.readString();
        }
      ...
      public static com.ryg.chapter_2.binderpool.ISecurityCenter sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(com.ryg.chapter_2.binderpool.ISecurityCenter impl) {
    ...
    public static com.ryg.chapter_2.binderpool.ISecurityCenter getDefaultImpl() {
